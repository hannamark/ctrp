...
Scenario: #1 I can view CTRP Users with the same site affilition and their Trial Ownership privileges
...
Scenario: #2 I can view CTRP Users with the same site affilition and their Trial Ownership privileges
Given I am logged into CTRP 
And I have Site Administrator privileges
When I select the Display Trial Ownership feature
And I see a list of all CTRP Users with the same Site Affiliation as I have listing:
| First Name |
| Last Name |
| Email |
| NCI ID of trial where they are a trial owner |
...
Scenario: #3 I can remove Trial Ownership priviledges from CTRP Users with the same site affilition
Given I am logged into CTRP 
And I have Site Administrator privileges
When I select the Display Trial Ownership feature
...
Scenario: #4 I can remove email notification from CTRP Users with the same site affilition
Given I am logged into CTRP 
And I have Site Administrator privileges
When I select the Display Trial Ownership feature
And I will see a list of all CTRP Users with the same Site Affiliation as I have listing:
