@Global
Feature: Global F02 Date Field Navigation

As a CTRP User, I enter a date in a date field directly or select a date from a calendar with month and year navigation
