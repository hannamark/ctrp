...
Scenario Outline: #1 I can change Clinical research Category for a trial
 ...
 Scenario:#1a Fields displayed when Clinical Research Category is set to "Interventional"
    Given I am on the Trial Design Screen
     When the Clinical Research Category Selected in "Interventional"
 ...
 Scenario:#1b Fields displayed when Clinical Research Category is set to "Expanded Access"
    Given I am on the Trial Design Screen
     When the Clinical Research Category Selected in "Expanded Access"
     Then the Trial Design Fields below will be displayed 
     
  |Clinical Research Category:Expanded Access|
  |Primary Purpose|
  |Secondary Purpose|
  |Trial Phase|
  |Is this a pilot?|
...
Scenario:#1c Fields displayed when Clinical Research Category is set to "Observational"
    Given I am on the Trial Design Screen
     When the Clinical Research Category Selected in "Observational"
     Then the Trial Design Fields below will be displayed 
     
  |Clinical Research Category:Observational|
  |Primary Purpose|
  |Trial Phase|
  |Is this a pilot?|
  |Study Model|
...
Scenario:#1d Fields displayed when Clinical Research Category is set to "Ancillary Correlative"
    Given I am on the Trial Design Screen
     When the Clinical Research Category Selected in "Ancillary Correlative"
     Then the Trial Design Fields below will be displayed 
     
  |Clinical Research Category:Ancillary Correlative|
  |Primary Purpose|
  |Trial Phase|
  |Is this a pilot?|
  |Study Model|
