...
|Expected Abstraction Completion Date (Defaulted to date of current Submission Milestone Date Plus 10 Business Days not editible) |
...
|Submission Type (Original (Information Source = Protocol and Submission number = 0) , Amendment (Information Source = Protocol and Submission number > 0), Imported (Information Source = Imported)|  
|Submitted On|
|Expected Abstraction Completion Date (Defaulted to Submission Date Plus 10 Business Days, not editible) |
|Accepted|
