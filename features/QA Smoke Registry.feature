...
Examples:
      ...
      | National                 | smokeSSLeadOrg     |                      |                              | smoke1234       | SS smoke Test Create Trial               | I     | yes         | Interventional   | Diagnostic     |                       | ICD9           | smoke TrialOrg | smoke TrialPI | smoke TrialOrg | smoke TrialOrg | pc1234      | yes         | R01                   | CA                 | 131421            | CDP                  | In Review   | smokeComment |                      | yes          | IND        | 998855       | CDER          | Investigator |                   | Sponsor          | Canada                | Health Canada      | Yes                   | No                  | Yes                     | testSampleDocFile.docx | testSampleXlsFile.xls |                      |                    |          | SubmitTrial            |
      | Institutional            | smokeSSLeadOrg IN  |                      |                              |                 | SS smoke Test Create Institutional Trial | II    | no          | Observational    | Treatment      | Ancillary-Correlative | ICD10          | smoke TrialOrg | smoke TrialPI | smoke TrialOrg | smoke TrialOrg | pc1234      | no          |                       |                    |                   |                      | In Review   | smokeComment |                      | no           |            |              |               |              |                   | Sponsor          | United States         | Federal Government | Yes                   | Yes                 | Yes                     | testSampleDocFile.docx | testSampleXlsFile.xls |                      |                    |          | SubmitTrial            |
      | Externally Peer-Reviewed | smokeSS Dft        |                      |                              |                 | SS smoke Test Create Draft Trial         |       |             |                  |                |                       |                |                |               |                |                |             |             |                       |                    |                   |                      |             |              |                      |              |            |              |               |              |                   |                  |                       |                    |                       |                     |                         |                        | testSampleXlsFile.xls |                      |                    |          | saveDraft              |
