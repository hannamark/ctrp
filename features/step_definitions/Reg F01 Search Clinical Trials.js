...
module.exports = function() {
    ...
    this.Given(/^I know the search Parameters of trial$/, function (callback) {
        projectFunctionsRegistry.createTrialForTrialSearch();
        browser.sleep(25).then(callback);
    });

    this.When(/^I select the option to search "([^"]*)"$/, function (arg1, callback) {
    ...
    this.Then(/^the Clinical Trials Search Results will display the following sorted by NCI Trial Identifier:$/, function (table, callback) {
    ...
    this.Then(/^CTRP will display all of my draft registrations that match the trial search criteria$/, function (callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
        searchTrial.setSearchTrialProtocolID(wildCardParameter);
        searchTrial.clickSearchTrialSearchButton();
    ...
    this.Then(/^the search results will display trials that contain the title search text$/, function (callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
    ...
    this.When(/^I select one or more trial Phase type$/, function (table, callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
    ...
    this.Then(/^the search results will display trials that match the Phase selected$/, function (callback) {
    ...
    this.When(/^I select a Pilot type$/, function (table, callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
    ...
    this.Then(/^the search results will display trials that have the Pilot criteria equal to the option selected type$/, function (table, callback) {
    ...
    this.When(/^I select one or more trial primary purpose type$/, function (table, callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
    ...
    this.Then(/^the search results will display trials that contain the protocol identifier search text$/, function (callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
    ...
    this.When(/^I select an organization from the organization name search look\-ahead$/, function (callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
        leadProtocolIDEX.then(function(trialLeadProtocolIDEX){
    ...
    this.Then(/^Trials that has the selected organization will be displayed$/, function (callback) {
    ...
    this.When(/^I select an organizations from an organization name search look\-ahead$/, function (callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
        leadProtocolIDEX.then(function(trialLeadProtocolIDEX){
            searchTrial.setSearchTrialOrganization(trialLeadProtocolIDEX);
    ...
    this.When(/^I select one or more Organization type as$/, function (table, callback) {
    ...
    this.Then(/^the search results will display trials where the organization selected has the organization role selected$/, function (callback) {
    ...
    this.Then(/^the search results will display trials where the person selected is principal investigator$/, function (callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
    ...
    this.Then(/^the search results will display trials with a matching Study Source$/, function (callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
    ...
    this.Then(/^the message "([^"]*)" will be displayed$/, function (arg1, callback) {
        trialMenuItem.clickTrials();
        trialMenuItem.clickListSearchTrialLink();
        searchTrial.clickMyTrials();
