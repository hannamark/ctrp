...
module.exports = function() {
    ...
    this.Given(/^I have completed a person search$/, function (callback) {
    ...
    this.When(/^I have cliked on the name of the person I want to view$/, function (callback) {
        per4.then(function (value) {
    ...
    this.Then(/^I will view person details type$/, function (table, callback) {
    ...
    this.Then(/^I should not be allowed to edit person parameters$/, function (callback) {
    ...
    this.Then(/^the following button type should also be invisible to the user$/, function (table, callback) {
