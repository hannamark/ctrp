...
module.exports = function() {
    ...
    this.Given(/^I have completed an organization search$/, function (callback) {
    ...
    this.When(/^I click on the organization name$/, function (callback) {
        orgSearch.then(function (value) {
    ...
    this.Then(/^I will be able to view Organization details type$/, function (table, callback) {
    ...
    this.Then(/^I should not be allowed to edit organization parameters$/, function (callback) {
    ...
    this.When(/^I click on Families Link$/, function (callback) {
        cukeFamily.then(function (value) {
            element(by.linkText(value)).click();
        });
        browser.sleep(25).then(callback);
    ...
    this.Then(/^I will view family details type$/, function (table, callback) {
        cukeFamily.then(function (value) {
    ...
    this.Then(/^I will view Organization details type$/, function (table, callback) {
        orgSearch.then(function(value) {
    ...
    this.Then(/^user can click to view details of these Organizations$/, function (callback) {
        orgSearch.then(function(value) {
            element(by.linkText(value)).click();
        });
        cukeFamily.then(function (value) {
    ...
    this.Then(/^Once on Family View page, user can also Search for another Family by going to Search Family$/, function (callback) {
