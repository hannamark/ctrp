...
var searchPeoplePage = require('../support/ListOfPeoplePage');
    ...
    module.exports = function() {
        ...
        this.Given(/^I have selected the option to Import an Industrial or Other Trial$/, function (callback) {
        ...
        this.Then(/^the Search Studies feature will indicate if the NCT ID is a valid NCT ID in ClinicalTrials\.gov$/, function (callback) {
        ...
        this.Then(/^the Search Studies feature will indicate if a trial with the NCT ID has been registered in CTRP$/, function (callback) {
        ...
        this.Given(/^I have selected the option to import an Industrial trial$/, function (callback) {
            browser.get('ui/#/main/sign_in');
            commonFunctions.onPrepareLoginTest('ctrptrialsubmitter');
            trialMenuItem.clickHomeSearchTrial();
            login.clickWriteMode('On');
        ...
        this.When(/^the Search Studies feature indicates that the trial has not been registered in CTRP$/, function (callback) {
        ...
        this.When(/^the trial NCT ID, Status, and Study Title, Conditions, and Interventions are displayed$/, function (callback) {
            projectFunctionsRegistry.verifyImportedTrialInfo();
            browser.sleep(25).then(callback);
        });


        this.When(/^the imported Clinical Trial does not have an Official Title$/, function (callback) {
        ...
        this.Then(/^the Clinical Trial Brief Title should be displayed in the search results$/, function (callback) {
             projectFunctionsRegistry.verifyImportedTrialInfo();
            browser.sleep(25).then(callback);
        });

        this.Then(/^I can import the trial information from ClinicalTrials\.gov into CTRP$/, function (callback) {
            importTrial.clickAddImportTrialButton();
        ...
        this.Then(/^the XML from ClinicalTrials\.gov will be added to the trial related document$/, function (callback) {
        ...
        this.Then(/^the trial milestone "([^"]*)" will be added with date of the import$/, function (arg1, table, callback) {
            nciIDOfTrial.then(function(value){
        ...
        this.Then(/^the trial milestone "([^"]*)" will be added with the date of the import$/, function (arg1, table, callback) {
            nciIDOfTrial.then(function(value){
                dbConnect.dbConnVerifyMilestoneImpTrial(value,getDBConnection);
            });
        browser.sleep(25).then(callback);
        ...
        this.Then(/^the trial Research Category will be listed as Expanded Access$/, function (callback) {
        ...
        this.Then(/^the trial status will match the trial status in ClinicalTrials\.gov as:$/, function (table, callback) {
            ctGovElement.then(function(value) {
        ...
        this.When(/^the NCT Number is associated with a Trial which has NOT been Rejected OR Submission Terminated$/, function (callback) {
        ...
        this.Then(/^the Trial with the entered NCT number should NOT be allowed to be imported$/, function (callback) {
        ...
        this.Then(/^the error message will be displayed "([^"]*)"$/, function (arg1, callback) {
        ...
        this.When(/^the NCT Number is associated with a Trial which has been Rejected OR Submission Terminated$/, function (callback) {
        ...
        this.Then(/^the Trial with the entered NCT number should be allowed to be imported$/, function (callback) {
            projectFunctionsRegistry.selectTrials('Industrial/Other');
            importTrial.setAddImportClinicalTrialID(NCTIDDuplicateSTR);
            importTrial.clickAddImportSearchStudiesButton();
        ...
        this.When(/^the lead organization and lead organization ID for the trial to be imported match the lead organization and lead organization ID for a trial registered in CTRP which has NOT been Rejected OR Submission Terminated$/, function (callback) {
        ...
        this.Then(/^The Trial with the associated lead organization and lead organization ID should not be allowed to be imported$/, function (callback) {
            browser.driver.wait(function () {
                console.log('wait here');
                return true;
            }, 40).then(function () {
        ...
        this.When(/^the lead organization and lead organization ID for the trial to be imported match the lead organization and lead organization ID for a trial registered in CTRP which has been Rejected OR Submission Terminated$/, function (callback) {
        ...
        this.Then(/^The Trial with the associated lead organization and lead organization ID should be allowed to be imported$/, function (callback) {
            browser.driver.wait(function () {
                console.log('wait here');
                return true;
            }, 40).then(function () {
        ...
        this.Given(/^I have imported the trial successfully$/, function (callback) {
        ...
        this.Then(/^the trial information will be displayed including$/, function (table, callback) {
       projectFunctionsRegistry.verifyImportedTrialViewPage();
            browser.sleep(25).then(callback);
        });

        this.Then(/^I can select the "([^"]*)" function to add my site as a participating site$/, function (arg1, callback) {
            assert.fail(0,1,'Button not present to Add PS after Importing Trial');
            browser.sleep(25).then(callback);
        });


        this.Given(/^I have completed the import$/, function (callback) {
        ...
        this.Given(/^I have selected the option to "([^"]*)"$/, function (arg1, callback) {
        ...
        this.Then(/^I can enter my Local Trial Identifier$/, function (callback) {
            participatingSite.setAddPSLocalId('local Trial Identifier 1234 cuke');
            browser.sleep(25).then(callback);
        });

        this.Then(/^look\-up and add the Site Principal Investigator$/, function (callback) {
        ...
        this.Then(/^enter a Program Code$/, function (callback) {
            participatingSite.setAddPSSiteProgramCode('site Prg Code cuke 99');
            browser.sleep(25).then(callback);
        });

        this.Then(/^enter the Recruitment Status and and Recruitment Status Date$/, function (callback) {
