json.people do
  json.array!(@people) do |person|
    json.extract! person, :id, :source_id, :fname, :mname, :lname, :prefix, :suffix, :email, :phone, :updated_at, :ctrp_id, :updated_by, :processing_status, :source_status_id, :source_context_id
