class TrialsController < ApplicationController
  ...
  def trial_params
    params.require(:trial).permit(:nci_id, :lead_protocol_id, :allocation_id, :official_title, :acronym, :pilot, :research_category_id,
                                  ...
                                  arms_groups_attributes: [:id, :label, :arms_groups_type, :description, :intervention_id, :trial_id, :_destroy],
                                  ...
                                  markers_attributes: [:id,:name,:protocol_marker_name,:biomarker_use_id,:evaluation_type_other,:assay_type_other,:_destroy,
