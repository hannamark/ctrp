class UsersController < ApplicationController
 ...
 # before_filter :authenticate_user!, :only => :update
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:username, :email, :zipcode, :first_name, :last_name, :middle_name,  :updated_at, :role, :street_address, :organization_id)
    end
end
