...
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAA', code: 'PAA96', item: 'paa_documents', rule: 'IRB Approved document is required', description: '‘IRB Approved Document’ Document  Type is required', remark: '[Select Trial Related Documents] from Administrative Data menu.')
...
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAS', code: 'PAS52', item: 'pas_biomarkers', rule: 'At least one pending biomarker exists on the trial.', description: 'At least one pending biomarker exists on the trial.', remark: '[Select Biomarkers] from Scientific Data menu.')
