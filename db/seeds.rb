...
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS27', item: 'pas_arms/groups', rule: 'Every intervention must be associated with at least one arm.', description: 'If Every INTERVENTION NAME not included in any ARM', remark: '[Select Arms/ Groups] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS28', item: 'pas_eligibility', rule: 'Eligibility Criteria is required', description: 'If Eligibility Criteria is null', remark: '[Select Eligibility Criteria] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS29', item: 'pas_eligibility', rule: 'Accepts Healthy Volunteersis required', description: 'If Accepts Healthy Volunteers on Eligibility is null', remark: '[Select Eligibility Criteria] from Scientific Data menu.')
...
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS33', item: 'pas_eligibility', rule: 'At least one Other Criteria is required', description: 'If Other Criteria is null', remark: '[Select Eligibility Criteria] from Scientific Data menu.')
