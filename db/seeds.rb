...
if Organization.all.size == 0
  ...
  org25 = Organization.find_or_create_by(id: 23170023,  name: 'National Cancer Institute', phone:'301-555-0000', source_status: source_act, source_context: ctrp, email: "cancerhelp@nih.gov", address: '9604 Medical Center Drive', city: 'Rockville', state_province:'Maryland', country:usa, postal_code:"20877") #no source id
