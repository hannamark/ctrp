...
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS26', item: 'pas_arms/groups', rule: 'Every arm must have one intervention UNLESS arm type is ‘no intervention’', description: 'Arms/Group Type Not Equal to ‘No Intervention’ AND Intervention Assignment for Arm is null', remark: '[Select Arms/ Groups] from Scientific Data menu.')
