...
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS34', item: 'pas_trial_design', rule: 'If Clinical Reasearch Category = ‘Observational’ ; Sampling Method is required', description: 'Clinical Research Category = ‘Observational’ AND Sampling Method is null', remark: '[Select Trial Design] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS35', item: 'pas_trial_design', rule: 'If Clinical Reasearch Category = ‘Ancillary Correlative’; Sampling Method is required', description: 'Clinical Research Category =  ‘Ancillary Correlative’ AND Sampling Method is null', remark: '[Select Trial Design] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS36', item: 'pas_trial_design', rule: 'If Clinical Reasearch Category of ‘Observational’ ; Study Population Description is required', description: 'Clinical Reasearch Category of ‘Observational’  AND  Study Population Description is null', remark: '[Select Trial Design] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS37', item: 'pas_trial_design', rule: 'If Clinical Reasearch Category of  ‘Ancillary Correlative’; Study Population Description is required', description: 'Clinical Reasearch Category of‘Ancillary Correlative’ AND  Study Population Description is null', remark: '[Select Trial Design] from Scientific Data menu.')
