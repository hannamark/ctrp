...
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAA', code: 'PAA90', item: 'paa_regulatory_info_fdaaa', rule: 'for IND protocols; Oversight Authorities must include the Country United States', description: 'trial has an associated IND/IDE AND Trial Oversight Authority Country is not USA', remark: 'Select [Regulatory Information FDAAA] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAA', code: 'PAA91', item: 'paa_regulatory_info_fdaaa', rule: 'for IND protocols; Oversight Authorities must include organization:  Food and Drug Administration', description: 'trial has an associated IND/IDE AND Trial Oversight Authority  Organization is not FDA', remark: 'Select [Regulatory Information FDAAA] from Administrative Data menu.')
...
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS25', item: 'pas_intervention', rule: 'Intervention term [INTERVENTION NAME] is INACTIVE.  Another term is required.', description: 'Trial Status = ACTIVE AND Intervention term status = INACTIVE', remark: '[Select Interventions] from Scientific Data menu.')
...
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS27', item: 'pas_arms/groups', rule: 'Every intervention must be associated with at least one arm.', description: 'Every INTERVENTION NAME not included in any ARM', remark: '[Select Arms/ Groups] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS28', item: 'pas_eligibility', rule: 'Eligibility Criteria is required', description: 'Eligibility Criteria is null', remark: '[Select Eligibility Criteria] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS29', item: 'pas_eligibility', rule: 'Accepts Healthy Volunteersis required', description: 'Accepts Healthy Volunteers on Eligibility is null', remark: '[Select Eligibility Criteria] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS30', item: 'pas_eligibility', rule: 'Gender is required', description: 'Gender is null', remark: '[Select Eligibility Criteria] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS31', item: 'pas_eligibility', rule: 'Minimum Age and Unit is required', description: 'Minimum Age and Unit are null', remark: '[Select Eligibility Criteria] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS32', item: 'pas_eligibility', rule: 'Maximum Age and Unitis required', description: 'Maximum Age and Unit are null', remark: '[Select Eligibility Criteria] from Scientific Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS33', item: 'pas_eligibility', rule: 'At least one Other Criteria is required', description: 'Other Criteria is null', remark: '[Select Eligibility Criteria] from Scientific Data menu.')
...
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAS', code: 'PAS39', item: 'pas_disease', rule: 'Disease/Condition [DISEASE NAME] is INACTIVE.  Another term is required.', description: 'Trial Status = ACTIVE and any  Disease/Condition status = INACTIVE', remark: '[Select Diseases/Conditions] from Scientific Data menu.')
...
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA185', item: 'paa_regulatory_info_human_subject_safety', rule: 'If Review Board is ‘Submitted; Denied’; Trial Status cannot be Approved', description: 'Board Approval Status = Submitted; Denied and Current Trial Status is approved', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA186', item: 'paa_regulatory_info_human_subject_safety', rule: 'If Board Approval Status is Submitted; Pending; Current Trial Status must be IN REVIEW', description: 'Board Approval status = Submitted; Pending; Current Trial Status is not  IN REVIEW', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
...
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA191', item: 'paa_regulatory_info_human_subject_safety', rule: 'If current trial status is withdrawn; Board Approval status in Regulatory Information – HSS must be ‘submitted denied’', description: 'Current trial status = WITHDRAWN and Board Approval status is not ‘SUBMITTED DENIED’', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA192', item: 'paa_regulatory_info_human_subject_safety', rule: 'Board status has been nullified. Board status is required.', description: 'Review Board status is null', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA193', item: 'paa_regulatory_info_human_subject_safety', rule: 'If the current trial status is In Review; the board approval status must be Submitted; Pending.', description: 'Trial Status is In Reviewand Board Approval Status is not Submitted; Pending', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
...
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA202', item: 'paa_participating_sites', rule: 'There are no Active Participating Sites exists for the trial.', description: 'Participating Site = null', remark: '[Select Participating Sites] from Administrative Data menu.')
...
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA204', item: 'paa_participating_sites', rule: 'Primary Investigator has been Nullified.  Primary Investigator is required', description: 'Primary Investigator has been set to Nullified', remark: '[Select Participating Sites] from Administrative Data menu.')
...
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA207', item: 'paa_participating_sites', rule: 'Target accrual is required', description: 'Target accrual is null', remark: '[Select Participating Sites] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA208', item: 'paa_nci_specific_info', rule: 'Data Table 4 Funding Sponsor status has been nullified.  Data Table 4 Funding Sponsor is required', description: 'Data Table 4 Funding Sponsor status is null', remark: '[Select [NCI Specific Information] from Administrative Data menu.')
...
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAS', code: 'PAS51', item: 'pas_arms/groups', rule: 'Arm label cannot be more than 62 characters', description: 'Arm Label > 62 characters', remark: '[Select Arms/Groups] from Scientific Data menu.')
