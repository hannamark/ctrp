...
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA187', item: 'paa_regulatory_info_human_subject_safety', rule: 'Current study status cannot be Active when Board Approval Status is submitted', description: 'Board Approval Status = ‘submitted’ And the  current study status  Active', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
