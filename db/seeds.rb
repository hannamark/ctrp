...
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAA', code: 'PAA4', item: 'paa_general_trial_details', rule: 'NCT Number cannot be more than 30 characters', description: '‘NCT Number’ >30 characters', remark: '[Select General Trial Details] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'error', model: 'trial', section: 'PAA', code: 'PAA5', item: 'paa_general_trial_details', rule: 'CTEP Number cannot be more than 30 characters', description: '‘CTEP Number’ >  30 characters', remark: '[Select General Trial Details] from Administrative Data menu.')
...
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA183', item: 'paa_regulatory_information_human_subject_safety', rule: 'Review Board Approval must be  SUBMITTED PENDING if Trial Status is   IN REVIEW', description: 'Current Trial Status = IN REVIEW and Board Approval Status is not Submitted; Pending', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA184', item: 'paa_regulatory_information_human_subject_safety', rule: 'Trial Status cannot be  ACTIVE when the  Review Board Approval is ‘Submitted; Denied’', description: 'Current Trial Status = ACTIVE; Board Approval Status = Submitted; Denied', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA185', item: 'paa_regulatory_information_human_subject_safety', rule: 'If Review Board is ‘Submitted; Denied’; Trial Status cannot be Approved', description: 'If Board Approval Status = Submitted; Denied and Current Trial Status is approved', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA186', item: 'paa_regulatory_information_human_subject_safety', rule: 'If Board Approval Status is Submitted; Pending; Current Trial Status must be IN REVIEW', description: 'If Board Approval status = Submitted; Pending; Current Trial Status is not  IN REVIEW', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA187', item: 'paa_regulatory_information_human_subject_safety', rule: 'Current study status cannot be Active when Board Approval Status is submitted', description: 'Board Approval Status = ‘submitted’ And the  current study status  Active', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA188', item: 'paa_regulatory_information_human_subject_safety', rule: 'Current study status cannot be Active when Board Approval Status is denied', description: 'Board Approval Status = ‘denied’ And the  current study status  Active', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA189', item: 'paa_regulatory_information_human_subject_safety', rule: 'Current study status cannot be Active when Board Approval Status is not required.', description: 'Board Approval Status =  ‘not required’   And the  current study status  Active', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA190', item: 'paa_regulatory_information_human_subject_safety', rule: 'Current study status cannot be Active when Board Approval Status is submitted; pending', description: 'Board Approval Status = ‘Submitted Pending’  And the  current study status  Active', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA191', item: 'paa_regulatory_information_human_subject_safety', rule: 'If current trial status is withdrawn; Board Approval status in Regulatory Information – HSS must be ‘submitted denied’', description: 'If Current trial status = WITHDRAWN and Board Approval status is not ‘SUBMITTED DENIED’', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA192', item: 'paa_regulatory_info_-human_subject_safety', rule: 'Board status has been nullified. Board status is required.', description: 'If Review Board status is null', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
ValidationRule.find_or_create_by(category: 'warning', model: 'trial', section: 'PAA', code: 'PAA193', item: 'paa_regulatory_info_-human_subject_safety', rule: 'If the current trial status is In Review; the board approval status must be Submitted; Pending.', description: 'If Trial Status is In Reviewand Board Approval Status is not Submitted; Pending', remark: '[Select Regulatory Information Human Subject Safety] from Administrative Data menu.')
