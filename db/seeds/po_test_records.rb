...
source_act_ctep = SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
source_inact_ctep = SourceStatus.find_by_code_and_source_context_id('INACT', ctep.id)
source_leg_ctep = SourceStatus.find_by_code_and_source_context_id('LEG', ctep.id)

source_act_nlm = SourceStatus.find_by_code_and_source_context_id('ACT', nlm.id),
    source_inact_nlm = SourceStatus.find_by_code_and_source_context_id('INACT', nlm.id)
...
#one org is already loaded for test accounts from root seed file
  ...
  org1 = Organization.find_or_create_by( id: 139020,
                                         ...
                                         address: '2450 Riverside Ave', city: 'Minneapolis', state_province: 'Minnesota', country:usa, postal_code: '35465', email: "ahaley@minnhealth.com")
  if !org1.new_record?
  ...
  org2 = Organization.find_or_create_by(id: 139049, source_id: 'MN022',
                                        name: 'University of Minnesota Medical Center-Fairview',
                                        phone:'315-425-2707',
                                        source_context: SourceContext.find_by_code('CTEP'),
                                        source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
                                        address: '516 Delaware St SE', city: 'Minneapolis', state_province:'Minnesota', country:usa, postal_code: '123432', email: "cdickens@minnhealth.com")
  if !org2.new_record?
    org2.name_aliases.find_or_create_by(name: 'Masonic Cancer Center, University of Minnesota')
  end

  org3 = Organization.find_or_create_by(id: 153109, source_id: 'NC164', processing_status: 'Active',  name: 'Coastal Carolina Radiation Oncology', phone:'315-425-2707',
                                        source_context: SourceContext.find_by_code('CTEP'),
                                        source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
  ...
  org4 = Organization.find_or_create_by(id: 12733422, processing_status: 'Active',  name: 'Comprehensive Cancer Center of Wake Forest University', phone:'315-425-2707',
  ...
  org5 = Organization.find_or_create_by(id: 117163, source_id: 'LA032', processing_status: 'Active',  name: 'Ochsner Baptist Medical Center', phone:'315-425-2707',
                                        source_context: SourceContext.find_by_code('CTEP'),
                                        source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
  ...
  org6 = Organization.find_or_create_by(id: 173475, source_id: 'NY139', processing_status: 'Active',  name: 'Syracuse Veterans Administration Medical Center',
                                        phone:'315-425-2707',
                                        source_context: SourceContext.find_by_code('CTEP'),
                                        source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
                                        address: ' 800 Irving Ave', city: 'Syracuse', state_province:'New York', country:usa, postal_code: '12347', email: "kdesai@syrhealth.com")

  org7 = Organization.find_or_create_by(id: 150970, source_id: 'NC088', processing_status: 'Active',  name: 'Veterans Administration Medical Center.', phone:'315-425-2707',
                                        source_context: SourceContext.find_by_code('CTEP'),
                                        source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
  ...
  org8 = Organization.find_or_create_by(id: 213850, source_id: 'WAKE', processing_status: 'Active',  name: 'Wake Forest NCORP Research Base', phone:'315-425-2707',
                                        source_context: SourceContext.find_by_code('CTEP'),
                                        source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
  ...
  org9 = Organization.find_or_create_by(id: 36296220, source_id: 'NC275', processing_status: 'Active',  name: 'Wake Forest University at Clemmons', phone:'315-425-2707',
                                        source_context: SourceContext.find_by_code('CTEP'),
                                        source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
  ...
  org14 = Organization.find_or_create_by(id: 149221, source_id: 'NC008', processing_status: 'Active',  name: 'Wake Medical Center-Breast Screening and Diagnostic',
                                         phone:'315-425-2707',
                                         source_context: SourceContext.find_by_code('CTEP'),
                                         source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
  ...
  org15 = Organization.find_or_create_by(id: 23875109, processing_status: 'Active',  name: 'ACORN Research, LLC', phone:'315-425-2707',
                                         source_context: SourceContext.find_by_code('CTRP'),
  ...
  org16 = Organization.find_or_create_by(id: 24068, source_id: 'ACT', phone:'315-425-2707', processing_status: 'Active',  name: 'Actelion Pharmaceuticals Switzerland',
                                         source_context: SourceContext.find_by_code('CTEP'),
                                         source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
  ...
  org17 = Organization.find_or_create_by(id: 8352734, processing_status: 'Active',  name: 'Boston University School Of Public Health',
                                         source_context: SourceContext.find_by_code('CTRP'),
                                         source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctrp.id),
  ...
  org18 = Organization.find_or_create_by(id: 34563051, processing_status: 'Active',  name: 'UCB, Inc.',
                                         source_context: SourceContext.find_by_code('CTRP'),
                                         source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctrp.id),
  ...
  org19 = Organization.find_or_create_by(processing_status: 'Active',  name: 'ACORN Research, LLC',
                                         source_context: SourceContext.find_by_code('CTEP'),
  ...
  org20 = Organization.find_or_create_by(id: 226701, source_id: 'TX111', processing_status: 'Active',  name: 'Texas Health Harris Methodist Hospital Fort Worth',
                                         phone:'865-541-1812',
                                         source_context: SourceContext.find_by_code('CTRP'),
                                         source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctrp.id),
...
org21 = Organization.find_or_create_by(id: 595150, source_id: 'CO029', processing_status: 'Active',  name: 'Memorial Hospital Colorado Springs', phone:'865-541-1813',
                                       source_context: SourceContext.find_by_code('CTRP'),
                                       source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctrp.id),
  ...
  org22 = Organization.find_or_create_by(id: 2118412, source_id: 'MA043', processing_status: 'Active',  name: 'Boston Medical Center', phone:'617-353-7571',
                                         source_context: SourceContext.find_by_code('CTRP'),
                                         source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctrp.id),
  ...
  org23 = Organization.find_or_create_by(id: 33699872, source_id: 'NVRF', processing_status: 'Active',  name: 'Nevada Cancer Research Foundation CCOP', phone:'702-541-1815',
                                         source_context: SourceContext.find_by_code('CTRP'),
                                         source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctrp.id),
  ...
  org24 = Organization.find_or_create_by(id: 8149074, source_id: 'WA002', processing_status: 'Active',  name: 'Harborview Medical Center', phone:'865-541-1816',
                                         source_context: SourceContext.find_by_code('CTRP'),
                                         source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctrp.id),
...
if Person.all.size == 0
  ...
  person7 = Person.find_or_create_by(id:366649, source_id:'11640',
                                     source_context: SourceContext.find_by_code('CTEP'),
                                     source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
                                     fname:'Christopher', mname:'Yancey', lname:'Thomas', prefix:'Dr.', suffix:'', email:'cythomas@wakehealth.edu', phone:'434-243-6143')
  ...
  Person.find_or_create_by(source_id:'AB123',
                           source_context: SourceContext.find_by_code('CTEP'),
                           source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
                           fname:'Daniel', mname:'Evan', lname:'Epner', prefix:'Dr.', suffix:'', email:'depner@ctep', phone:'123-456-7890', ctrp_id: person8.id)
  ...
  person9 = Person.find_or_create_by(id:672434, source_id:'19844',
                                     source_context: SourceContext.find_by_code('CTEP'),
                                     source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
                                     fname:'David', mname:'Marc', lname:'Peereboom', prefix:'Dr.', suffix:'', email:'peerebd@ccf.org', phone:'866-223-8100')
