...
if Person.all.size == 0
  ...
  person7 = Person.find_or_create_by(id:366649, source_id:'11640',
                                     source_context: SourceContext.find_by_code('CTEP'),
                                     source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
                                     fname:'Christopher', mname:'Yancey', lname:'Thomas', prefix:'Dr.', suffix:'', email:'cythomas@wakehealth.edu', phone:'434-243-6143', registration_type: 'Principal Investigator')
  ...
  Person.find_or_create_by(source_id:'AB123',
                           source_context: SourceContext.find_by_code('CTEP'),
                           source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
                           fname:'Daniel', mname:'Evan', lname:'Epner', prefix:'Dr.', suffix:'', email:'depner@ctep', phone:'123-456-7890', ctrp_id: person8.id, registration_type: 'Principal Investigator')
  ...
  person9 = Person.find_or_create_by(id:672434, source_id:'19844',
                                     source_context: SourceContext.find_by_code('CTEP'),
                                     source_status: SourceStatus.find_by_code_and_source_context_id('ACT', ctep.id),
                                     fname:'David', mname:'Marc', lname:'Peereboom', prefix:'Dr.', suffix:'', email:'peerebd@ccf.org', phone:'866-223-8100', registration_type: 'Principal Investigator')
