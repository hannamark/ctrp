...
org4 = Organization.create(po_id: 12733422, name: 'Comprehensive Cancer Center of Wake Forest University', source_status: source_act, address: '', city: '', state:'NC', country: usa) #cannot find address
...
org8 = Organization.create(po_id: 213850, source_id: 'WAKE', name: 'Wake Forest NCORP Research Base', source_status: source_act, source_context: ctep, address: '', city: '', state:'', country: usa) #cannot find address
if !org8.new_record?
...
org13 = Organization.create(po_id: 149074, source_id: 'NC002', name: 'Wake Forest University Health Sciences', source_status: source_act, source_context: ctep, address: '	1 Medical Center Blvd', city: 'Winston-Salem', state:'NC', country: usa) #missing some information
...
org15 = Organization.create(po_id: 23875109, name: 'ACORN Research, LLC', source_status: source_pend,address: '6555 Quince Rd', city: 'Memphis', state:'TN', country: usa) #missing some of the information that other organizations have
org16 = Organization.create(po_id: 24068, source_id: 'ACT', name: 'Actelion Pharmaceuticals Switzerland', source_status: source_act, source_context: ctep, address: 'Gewerbestrasse 16', city: 'Allschwil', state:'', country: 'Switzerland')
if !org16.new_record?
  org16.name_aliases.create(name: 'Actelion')
end
org17 = Organization.create(po_id: 8352734, name: 'Boston University School Of Public Health', source_status: source_act, address: '715 Albany St', city: 'Boston', state:'MA', country: usa) #missing some of the information that other organizations have
org18 = Organization.create(po_id: 34563051, name: 'UCB, Inc.', source_status: source_act, address: '1950 Lake Park Drive', city: 'Smyrna', state:'GA', country: usa) #missing some of the information that other organizations have
if !org18.new_record?
