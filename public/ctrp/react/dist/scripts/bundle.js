...
var Header = React.createClass({displayName: "Header",
	render: function() {
		return (
			React.createElement("nav", {className: "navbar navbar-default navbar-fixed-top nav-search-bar"}, 
				React.createElement("div", {className: "container-fluid"}, 
					React.createElement(Link, {to: "app", className: "navbar-brand"}, "Home"), 
					React.createElement("div", {className: "collapse navbar-collapse"}, 
						React.createElement("ul", {className: "nav navbar-nav inline"}, 
							React.createElement("li", {className: "dropdown"}, 
								React.createElement("a", {href: "#", className: "dropdown-toggle", "data-toggle": "dropdown", role: "button", 
								"aria-expanded": "false"}, "Organizations & Families ", React.createElement("span", {className: "caret"})), 
								React.createElement("ul", {className: "dropdown-menu", role: "menu"}, 
									React.createElement("li", null, React.createElement("a", {hre: ""}, "Search Organizations")), 
									React.createElement("li", null, React.createElement("a", {hre: ""}, "Add Organization")), 
									React.createElement("li", {role: "separator", className: "divider"}), 
									React.createElement("li", null, React.createElement("a", {hre: ""}, "Search Families")), 
									React.createElement("li", null, React.createElement("a", {hre: ""}, "Add Family"))									
								)
							), 

							React.createElement("li", {className: "dropdown"}, 
								React.createElement("a", {href: "#", className: "dropdown-toggle", "data-toggle": "dropdown", role: "button", 
								"aria-expanded": "false"}, "Persons", React.createElement("span", {className: "caret"})), 
								React.createElement("ul", {className: "dropdown-menu", role: "menu"}, 
									React.createElement("li", null, React.createElement("a", {hre: ""}, "Search Persons")), 
									React.createElement("li", null, React.createElement("a", {hre: ""}, "Add Person"))
								)
							), 

							React.createElement("li", null, React.createElement(Link, {to: "searchOrgs"}, "Search Organizations"))
	...
	render: function() {
		...
		return (
			React.createElement("div", {className: wrapperClass}, 
				...
				React.createElement("input", {type: "text", name: this.props.name, className: "form-control", 
				placeholder: this.props.placeholder, ref: this.props.name, value: this.props.value, 
	...
	render: function() {
		return (
			React.createElement("div", {className: "jumbotron"}, 
				React.createElement("h1", null, "CTRP - NCI"), 
				React.createElement("a", {href: "#", className: "btn btn-primary btn-lg"}, "Learn more ")
			)
			);
	}
});
...
var ManageOrgPage = React.createClass({displayName: "ManageOrgPage",
	mixins: [Router],
	...
	render: function() {
		return (
			React.createElement(OrgSearchForm, {searchParams: this.state.searchParams, onChange: this.setOrgSearchState, onSubmit: this.submitForm})
			);
	}
...
},{"./orgSearchForm":203,"react":196,"react-router":27,"toastr":197}],203:[function(require,module,exports){
...
var OrgSearchForm = React.createClass({displayName: "OrgSearchForm",
	propTypes: {
			...
			React.createElement("div", {className: "container"}, 
				React.createElement("div", {className: "row"}, 
					React.createElement("form", {className: "form-horizontal", role: "form"}, 
							React.createElement("h4", null, "Search Organizations ", React.createElement("small", null, React.createElement("mark", null, "* for wild card (e.g. university* for any university)"))), 
							React.createElement(Input, {name: "organizationName", label: "Organization Name", onChange: this.props.onChange}), 
							React.createElement("input", {type: "submit", value: "Search", className: "btn btn-primary", onClick: this.props.onSubmit})	
					)
				)
			)
			);
...
},{"../common/textInput":200,"react":196}],204:[function(require,module,exports){
'use strict';
...
Router.run(routes, function(Handler) {
	React.render(React.createElement(Handler, null), document.getElementById('ctrp-app'));
});

},{"./route":205,"react":196,"react-router":27}],205:[function(require,module,exports){
'use strict';
...
var routes = (
		...
		React.createElement(Route, {name: "searchOrgs", path: "searchOrgs", handler: require('./components/organizations/manageOrgPage')})
		)
	);

module.exports = routes;

},{"./components/app":198,"./components/homePage":201,"./components/organizations/manageOrgPage":202,"react":196,"react-router":27}]},{},[204]);
