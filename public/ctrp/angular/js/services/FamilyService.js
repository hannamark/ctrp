    ...
    function FamilyService(PromiseService, URL_CONFIGS, $log, $rootScope) {
        ...
        var gridOptions = {
            ...
            columnDefs: [
                ...
                {name: 'aff_orgs', displayName:'Family Members',width:'30%',cellTemplate:'<div ng-show="row.entity.aff_orgs.length > 0"><master-directive button-label="Family Members" mod="row.entity.aff_orgs"></master-directive></div><div ng-show="row.entity.aff_orgs.length == 0">--</div>'}
            ]
        };
