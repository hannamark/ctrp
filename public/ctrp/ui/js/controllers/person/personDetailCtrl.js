...
(function () {
    ...
    function personDetailCtrl(personDetailObj, PersonService, toastr, DateService, UserService,
        ...
        $scope.checkForNameUniqueness = function(){
            ...
            var searchParams = {"person_fname": vm.curPerson.fname, "person_lname": vm.curPerson.lname, "source_context_id": vm.curPerson.source_context_id, "person_exists": angular.isObject(personDetailObj)};
